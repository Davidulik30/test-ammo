...
const TANK_PATHS := {
	"LemanRuss": "res://artilerry/Tank/LemanRuss.tscn",
	"Predator": "res://artilerry/Tank/Predator.tscn",
	"default": "res://artilerry/Tank/tank.tscn"
}
...
func _ready() -> void:
	...
	if players.size() == 0:
		print("[ArtilerryScene] No players data found; skipping spawn.")
		return
